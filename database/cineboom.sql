...
-- Crear en phpMyAdmin de XAMPP (puerto 3307)
-- ============================================
...
-- Admin por defecto  (usuario: admin | contraseña: password)
...
-- Para usar otra contraseña ejecuta en PHP: echo password_hash('tuClave', PASSWORD_DEFAULT);
